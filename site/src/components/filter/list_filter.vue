    ...
    <div class="window-filter" id="window-filter">
        <div class="filter-header">
            ...
            <div class="i-cancel-wrap" @click="closeWindow()">
                <img class="i-cancel" :src="images.close" style="position:relative;top:50%;transform:translateY(-50%);width: 25px;height:auto;">
            </div>
        </div>
        <!-- 左侧tab -->
    ...
    export default {
        ...
        compiled() {
            ...
            Vue.nextTick(function(){
                self.filter_category_style = true;

                var star_y_state = false;
                var startY = 0;
                var Y_dis = 0;
                var timeStamp = 0;
                document.getElementById('window-filter').addEventListener("touchstart", function(e) {
                ...
                document.getElementById('window-filter').addEventListener("touchmove", function(e) {

                    var data = self.listenerTouchMove( self.tran_distance,startY, star_y_state, Y_dis, document.getElementById('card-move').offsetHeight -
                                                                                                       document.getElementById('window-filter').offsetHeight +
                                                                                                       100, e);
                    self.tran_distance = data.tran_y;
